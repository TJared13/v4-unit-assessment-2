...
const blueProducts = products.filter(elem => {
...
//CODE HERE
const orderTotal = products.map(elem => elem.price).reduce((sum, elem) => sum + elem)
//////////////////////////////////PROBLEMS 5-8//////////////////////////////////
/*
...
//CODE HERE
let {zipCode: zipCode, state: state} = shippingInfo
