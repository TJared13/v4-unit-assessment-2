...
let bestMovie = elem => `${elem} is the best movie ever!`;
...
//CODE HERE
  let phone1 = new Phone('iPhone', 'Xs', 256, 'Space Gray', false)
  
  let phone2 = new Phone('iPhone', 'mini', 64, 'Silver', false)
  
  let phone3 = new Phone('Samsung', 'Galaxy', 64, 'Red', false)
